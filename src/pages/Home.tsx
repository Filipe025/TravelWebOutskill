    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <section className="relative bg-gradient-to-r from-blue-600 to-sky-500">
        ...
        <div
          ...
          style={{
            backgroundImage: 'url(https://images.pexels.com/photos/1020016/pexels-photo-1020016.jpeg?auto=compress&cs=tinysrgb&w=1920)'
          }}
        ></div>
        
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
            <h1 className="text-4xl md:text-6xl font-bold mb-6 text-white drop-shadow-lg" style={{ WebkitTextStroke: '1px rgba(255, 255, 255, 0.3)', textStroke: '1px rgba(255, 255, 255, 0.3)', textShadow: '3px 3px 8px rgba(0, 0, 0, 0.7), 1px 1px 3px rgba(0, 0, 0, 0.5)' }}>
